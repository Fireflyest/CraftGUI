...
public class SerializeCustomUtil {
    ...
    public static String serializeItemMeta(ItemStack itemStack, boolean mysql){
        ...
        if (itemMeta instanceof SkullMeta && XMaterial.getVersion() > 17) {
    ...
    private static ItemMeta deserializeItemMeta(Map<String, Object> map) {
        ...
        switch (metaType){
            ...
            case "SKULL": {
                if ( map.containsKey("skull-owner") && XMaterial.getVersion() > 17){
        ...
        if (skull != null && XMaterial.getVersion() > 17)  meta = SkullUtils.applySkin(meta, skull);
        return meta;
    }
